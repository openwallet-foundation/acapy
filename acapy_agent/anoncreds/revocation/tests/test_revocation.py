...
class MockRevListEntry:
    ...
    value_json = {
        "rev_list": {
            "issuerId": "CsQY9MGeD3CQP4EyuVFo5m",
            "revRegDefId": "4xE68b6S5VRFrKMMG1U95M:4:4xE68b6S5VRFrKMMG1U95M:3:CL:59232:default:CL_ACCUM:4ae1cc6c-f6bd-486c-8057-88f2ce74e960",  # noqa: E501
...
class TestAnonCredsRevocation(IsolatedAsyncioTestCase):
    ...
    async def test_create_and_register_revocation_registry_definition_fails_to_get_cred_def(  # noqa: E501
        self,
    ):
        # AnonCreds error
