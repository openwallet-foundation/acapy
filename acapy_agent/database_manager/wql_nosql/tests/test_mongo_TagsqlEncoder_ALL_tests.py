...
class TestMongoTagEncoder(unittest.TestCase):
    ...
    def verify_round_trip(self, query, original_mongo_query):
        ...
        self.assertEqual(original_mongo_query, parsed_mongo_query, f"Round-trip MongoDB query mismatch in {self._testMethodName}")
    ...
    def test_gte_positive(self):
        ...
        self.run_query_and_verify(mongo_query, [2, 3, 4], "Positive greater-than-or-equal")
    ...
    def test_comparison_conjunction(self):
        ...
        mongo_query = self.encoder.encode_query(query)
        expected_query = {"$and": [{"category": "electronics"}, {"price": {"$gt": "100"}}]}
    ...
    def test_deeply_nested_not(self):
        ...
        expected_query = {
            "$or": [
                {"$and": [{"category": {"$ne": "electronics"}}, {"sale": {"$ne": "yes"}}]},
                {"stock": "out"}
            ]
        }
    ...
    def test_and_or_not_complex_case(self):
        ...
        doc_bob = {"username": "bob", "age": "25", "height": "170", "score": "150", "timestamp": "2021-02-01T00:00:00", "secret_code": "xyz789", "occupation": "engineer", "status": "inactive"}
        doc_alice = {"username": "alice", "age": "35", "height": "190", "score": "90", "timestamp": "2020-12-01T00:00:00", "secret_code": "def456", "occupation": "developer", "status": "active"}
        doc_charlie = {"username": "charlie", "age": "28", "height": "175", "score": "120", "timestamp": "2021-03-01T00:00:00", "secret_code": "ghi789", "occupation": "manager", "status": "active"}
        doc_dave = {"username": "alice", "age": "32", "height": "185", "score": "95", "timestamp": "2020-11-01T00:00:00", "secret_code": "abc123", "occupation": "developer", "status": "inactive"}
        doc_eve = {"username": "eve", "age": "40", "height": "160", "score": "85", "timestamp": "2021-01-15T00:00:00", "secret_code": "abc123", "occupation": "analyst", "status": "active"}
        doc_frank = {"username": "frank", "age": "29", "height": "182", "score": "105", "timestamp": "2020-12-15T00:00:00", "secret_code": "jkl012", "occupation": "developer", "status": "active"}
        doc_grace = {"username": "alice", "age": "33", "height": "195", "score": "88", "timestamp": "2020-10-01T00:00:00", "secret_code": "mno345", "occupation": "developer", "status": "active"}
        doc_hank = {"username": "hank", "age": "27", "height": "165", "score": "110", "timestamp": "2021-04-01T00:00:00", "secret_code": "pqr678", "occupation": "designer", "status": "inactive"}
        doc_ivy = {"username": "alice", "age": "36", "height": "188", "score": "92", "timestamp": "2020-09-01T00:00:00", "secret_code": "stu901", "occupation": "developer", "status": "active"}
        doc_jack = {"username": "jack", "age": "31", "height": "179", "score": "115", "timestamp": "2021-05-01T00:00:00", "secret_code": "vwx234", "occupation": "teacher", "status": "active"}
        doc_kara = {"username": "kara", "age": "26", "height": "170", "score": "130", "timestamp": "2021-06-01T00:00:00", "secret_code": "yza567", "occupation": "developer", "status": "inactive"}
        doc_leo = {"username": "alice", "age": "34", "height": "192", "score": "87", "timestamp": "2020-08-01T00:00:00", "secret_code": "bcd890", "occupation": "developer", "status": "active"}


        # Insert into the collection
        result = self.collection.insert_many([
            doc_bob, doc_alice, doc_charlie, doc_dave, doc_eve, doc_frank,
            doc_grace, doc_hank, doc_ivy, doc_jack, doc_kara, doc_leo
        ])
