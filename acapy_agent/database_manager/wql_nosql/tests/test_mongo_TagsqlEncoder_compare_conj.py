...
class TestMongoTagEncoder(unittest.TestCase):
    def test_comparison_conjunction(self):
        ...
        print("   - _id: 1: category='electronics', price='150' > '100' (lexicographical)")
        print("   - _id: 2: category='electronics', price='090' < '100' (lexicographical)")
        print("   - _id: 3: category='books', price='120' (category mismatch)")
        print("   - _id: 4: category='electronics', price='200' > '100' (lexicographical)")
