    ...
    def translate_error(self, exception):
        ...
        database_error_mapping = {
            DatabaseErrorCode.DATABASE_NOT_FOUND: (
                DBStoreErrorCode.NOT_FOUND, "Database Not Found"
            ),
            DatabaseErrorCode.UNSUPPORTED_VERSION: (
                DBStoreErrorCode.UNSUPPORTED, "Unsupported release number in config table"
            ),
            DatabaseErrorCode.DEFAULT_PROFILE_NOT_FOUND: (
                DBStoreErrorCode.NOT_FOUND, "Database default profile not found"
            ),
            DatabaseErrorCode.PROFILE_NOT_FOUND: (
                DBStoreErrorCode.NOT_FOUND, "Database profile not found"
            ),
            DatabaseErrorCode.CONNECTION_POOL_EXHAUSTED: (
                DBStoreErrorCode.UNEXPECTED, "Connection pool exhausted"
            ),
            DatabaseErrorCode.PROFILE_ALREADY_EXISTS: (
                DBStoreErrorCode.DUPLICATE, "Profile already exists"
            ),
            DatabaseErrorCode.RECORD_NOT_FOUND: (
                DBStoreErrorCode.NOT_FOUND, "Record not found"
            ),
            DatabaseErrorCode.DUPLICATE_ITEM_ENTRY_ERROR: (
                DBStoreErrorCode.DUPLICATE, "Duplicate Item Entry Error"
            ),
            DatabaseErrorCode.DATABASE_NOT_ENCRYPTED: (
                DBStoreErrorCode.UNEXPECTED, "Cannot rekey an unencrypted database"
            ),
            DatabaseErrorCode.CONNECTION_ERROR: (
                DBStoreErrorCode.UNEXPECTED, "Connection error"
            ),
            DatabaseErrorCode.QUERY_ERROR: (
                DBStoreErrorCode.UNEXPECTED, "Query error"
            ),
            DatabaseErrorCode.PROVISION_ERROR: (
                DBStoreErrorCode.UNEXPECTED, "Provision error"
            ),
        }
