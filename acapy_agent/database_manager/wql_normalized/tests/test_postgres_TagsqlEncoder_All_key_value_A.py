...
class TestPostgresTagEncoderNonNormalizedA(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.encoder = encoder_factory.get_encoder('postgresql', self.enc_name, self.enc_value, normalized=False)
    ...
    def test_eq_positive(self):
        ...
        expected_query = "i.id IN (SELECT item_id FROM items_tags WHERE name = %s AND value = %s)"
        ...
        self.cursor.executemany("INSERT INTO items (id) VALUES (%s) RETURNING id", [(1,), (2,), (3,)])
        ...
        print("CREATE TABLE items_tags (item_id INTEGER, name TEXT, value TEXT, FOREIGN KEY(item_id) REFERENCES items(id));")
    ...
    def test_eq_negated(self):
        ...
        sql_query, params = self.encoder.encode_query(query)
        expected_query = "i.id NOT IN (SELECT item_id FROM items_tags WHERE name = %s AND value = %s)"
        expected_params = ["field", "value"]
    ...
    def test_gt_positive(self):
        ...
        self.verify_round_trip(query, sql_query, params)
        self.cursor.executemany("INSERT INTO items (id) VALUES (%s) RETURNING id", [(1,), (2,), (3,), (4,)])
        self.cursor.executemany(
            "INSERT INTO items_tags (item_id, name, value) VALUES (%s, %s, %s)",
    ...
    def test_like_positive(self):
        ...
        sql_query, params = self.encoder.encode_query(query)
        expected_query = "i.id IN (SELECT item_id FROM items_tags WHERE name = %s AND value LIKE %s)"
