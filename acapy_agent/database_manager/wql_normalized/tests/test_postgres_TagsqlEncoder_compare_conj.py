...
class TestPostgresTagEncoder(unittest.TestCase):
    ...
    def test_comparison_conjunction(self):
        ...
        self.assertEqual(query_str, expected_query, "Comparison conjunction query mismatch")
        ...
        expected_ids = [1, 4]
        self.assertEqual(actual_ids, expected_ids, f"Comparison conjunction failed: Expected IDs {expected_ids}, got {actual_ids}")
