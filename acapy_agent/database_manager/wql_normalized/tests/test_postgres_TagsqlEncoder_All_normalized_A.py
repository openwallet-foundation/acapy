...
class TestPostgresTagEncoderNormalized(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.encoder = encoder_factory.get_encoder('postgresql', self.enc_name, self.enc_value, normalized=True)
    ...
    def run_query_and_verify(self, sql_query, params, expected_ids, test_name):
        ...
        try:
            ...
            logger.info(f"Executing query: SELECT id FROM items AS t WHERE {query} with params: {params}")
    ...
    def verify_round_trip(self, query, original_sql_query, original_params):
        ...
        parsed_sql_query_str = parsed_sql_query[0] if isinstance(parsed_sql_query, tuple) else parsed_sql_query
        self.assertEqual(
    ...
    def test_eq_positive(self):
        ...
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Positive equality query mismatch")
    ...
    def test_eq_negated(self):
        ...
        expected_params = ["value"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Negated equality query mismatch")
    ...
    def test_neq_positive(self):
        ...
        expected_query = "t.field != %s"
        expected_params = ["value"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Positive inequality query mismatch")
    ...
    def test_neq_negated(self):
        ...
        expected_query = "NOT (t.field != %s)"
        expected_params = ["value"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Negated inequality query mismatch")
    ...
    def test_gt_positive(self):
        ...
        expected_params = ["100"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Positive greater-than query mismatch")
    ...
    def test_gt_negated(self):
        ...
        expected_params = ["100"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Negated greater-than query mismatch")
    ...
    def test_gte_positive(self):
        ...
        expected_query = "t.price >= %s"
        expected_params = ["100"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Positive greater-than-or-equal query mismatch")
    ...
    def test_gte_negated(self):
        ...
        expected_query = "NOT (t.price >= %s)"
        expected_params = ["100"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Negated greater-than-or-equal query mismatch")
    ...
    def test_lt_positive(self):
        ...
        expected_query = "t.price < %s"
        expected_params = ["100"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Positive less-than query mismatch")
    ...
    def test_lt_negated(self):
        ...
        expected_query = "NOT (t.price < %s)"
        expected_params = ["100"]
        self.assertEqual(sql_query[0] if isinstance(sql_query, tuple) else sql_query, expected_query, "Negated less-than query mismatch")
