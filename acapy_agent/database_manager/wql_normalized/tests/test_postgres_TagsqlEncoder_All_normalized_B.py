...
class TestPostgresTagEncoderNormalized(unittest.TestCase):
    ...
    def test_deeply_nested_not(self):
        ...
        self.conn.commit()
        print("\n### Complete SQL Statements for Testing")
        print("CREATE TABLE items (id SERIAL PRIMARY KEY, category TEXT, sale TEXT, stock TEXT);")
    ...
    def test_and_or_not_complex_case(self):
        ...
        print("\n### Complete SQL Statements for Testing")
        print("CREATE TABLE items (id SERIAL PRIMARY KEY, username TEXT, age TEXT, height TEXT, score TEXT, timestamp TEXT, secret_code TEXT, occupation TEXT, status TEXT);")
