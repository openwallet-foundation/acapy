...
class TestTagSqlEncoder(unittest.TestCase):
    ...
    def test_or_conjunction(self):
        ...
        expected_args = [
            "tag_a", "value_a",  # condition_1: tag_a = value_a
            "tag_b", "value_b",  # condition_1: tag_b = value_b
            "tag_a", "value_a",  # condition_2: tag_a = value_a
            "tag_b", "value_c"   # condition_2: NOT (tag_b = value_c)
        ]
