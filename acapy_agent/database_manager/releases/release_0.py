...
RELEASE = {
    "default": {
        "handlers": {
            "sqlite": lambda: SqliteGenericHandler(category="default", tags_table_name="items_tags"),
            "postgresql": lambda: PostgresqlGenericHandler(category="default", tags_table_name="items_tags", schema_context=SchemaContext())
        },
        "schemas": None
    }
}