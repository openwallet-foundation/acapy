...
SCHEMAS = {
    "sqlite": [
        ...
        """,
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_item_id_v0_1 ON connection_metadata_v0_1 (item_id);",
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_item_name_v0_1 ON connection_metadata_v0_1 (item_name);",
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_key_v0_1 ON connection_metadata_v0_1 (key);",
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_connection_id_v0_1 ON connection_metadata_v0_1 (connection_id);",
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_created_at_v0_1 ON connection_metadata_v0_1 (created_at);",
        """
        CREATE TABLE IF NOT EXISTS connection_metadata_attributes_v0_1 (
            ...
            value TEXT NOT NULL,
            FOREIGN KEY (connection_metadata_id) REFERENCES connection_metadata_v0_1(id) ON DELETE CASCADE ON UPDATE CASCADE
        );
        """,
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_attributes_metadata_key_v0_1 ON connection_metadata_attributes_v0_1 (metadata_key);",
        """
        CREATE TRIGGER IF NOT EXISTS trg_insert_connection_metadata_attributes_v0_1
        AFTER INSERT ON connection_metadata_v0_1
        FOR EACH ROW
        WHEN NEW.metadata IS NOT NULL AND json_valid(NEW.metadata) AND json_type(NEW.metadata) = 'object'
        BEGIN
            INSERT INTO connection_metadata_attributes_v0_1 (connection_metadata_id, metadata_key, value)
            SELECT
                NEW.id,
                key,
        ...
        FOR EACH ROW
        WHEN NEW.metadata IS NOT NULL AND json_valid(NEW.metadata) AND json_type(NEW.metadata) = 'object' AND NEW.metadata != OLD.metadata
        BEGIN
            DELETE FROM connection_metadata_attributes_v0_1 WHERE connection_metadata_id = OLD.id;
            INSERT INTO connection_metadata_attributes_v0_1 (connection_metadata_id, metadata_key, value)
            SELECT
                NEW.id,
                key,
    ...
    "postgresql": [
        ...
        CREATE TABLE IF NOT EXISTS connection_metadata_attributes_v0_1 (
            ...
            metadata_key TEXT NOT NULL,
            value TEXT NOT NULL,
            CONSTRAINT fk_connection_metadata_id FOREIGN KEY (connection_metadata_id) REFERENCES connection_metadata_v0_1(id) ON DELETE CASCADE ON UPDATE CASCADE
        );
        """,
        "CREATE INDEX IF NOT EXISTS idx_connection_metadata_attributes_metadata_key_v0_1 ON connection_metadata_attributes_v0_1 (metadata_key);",
        """
        ...
        RETURNS TRIGGER AS $$
        BEGIN
            IF NEW.metadata IS NOT NULL AND NEW.metadata::jsonb IS NOT NULL AND jsonb_typeof(NEW.metadata::jsonb) = 'object' THEN
                INSERT INTO connection_metadata_attributes_v0_1 (connection_metadata_id, metadata_key, value)
                SELECT
                    NEW.id,
                    key,
        ...
        RETURNS TRIGGER AS $$
        BEGIN
            IF NEW.metadata IS NOT NULL AND NEW.metadata::jsonb IS NOT NULL AND jsonb_typeof(NEW.metadata::jsonb) = 'object' AND NEW.metadata != OLD.metadata THEN
                DELETE FROM connection_metadata_attributes_v0_1 WHERE connection_metadata_id = OLD.id;
                INSERT INTO connection_metadata_attributes_v0_1 (connection_metadata_id, metadata_key, value)
                SELECT
                    NEW.id,
    ...
    "mssql": [
        ...
        """,
        "CREATE NONCLUSTERED INDEX idx_connection_metadata_item_id_v0_1 ON connection_metadata_v0_1 (item_id);",
        "CREATE NONCLUSTERED INDEX idx_connection_metadata_item_name_v0_1 ON connection_metadata_v0_1 (item_name);",
        "CREATE NONCLUSTERED INDEX idx_connection_metadata_key_v0_1 ON connection_metadata_v0_1 (key);",
        "CREATE NONCLUSTERED INDEX idx_connection_metadata_connection_id_v0_1 ON connection_metadata_v0_1 (connection_id);",
        "CREATE NONCLUSTERED INDEX idx_connection_metadata_created_at_v0_1 ON connection_metadata_v0_1 (created_at);",
        """
        ...
        """,
        "CREATE NONCLUSTERED INDEX idx_connection_metadata_attributes_metadata_key_v0_1 ON connection_metadata_attributes_v0_1 (metadata_key);",
        """
        CREATE TRIGGER trg_insert_connection_metadata_attributes_v0_1
...
DROP_SCHEMAS = {
    ...
    "postgresql": [
        "DROP TRIGGER IF EXISTS trg_update_connection_metadata_timestamp_v0_1 ON connection_metadata_v0_1;",
        "DROP FUNCTION IF EXISTS update_connection_metadata_timestamp_v0_1 CASCADE;",
        "DROP TRIGGER IF EXISTS trg_update_connection_metadata_attributes_v0_1 ON connection_metadata_v0_1;",
        "DROP FUNCTION IF EXISTS update_connection_metadata_attributes_v0_1 CASCADE;",
        "DROP TRIGGER IF EXISTS trg_insert_connection_metadata_attributes_v0_1 ON connection_metadata_v0_1;",
    ...
    "mssql": [
        ...
        "DROP TRIGGER IF EXISTS trg_update_connection_metadata_attributes_v0_1;",
        "DROP TRIGGER IF EXISTS trg_insert_connection_metadata_attributes_v0_1;",
        "DROP INDEX IF EXISTS idx_connection_metadata_attributes_metadata_key_v0_1 ON connection_metadata_attributes_v0_1;",
        "DROP TABLE IF EXISTS connection_metadata_attributes_v0_1;",
        "DROP INDEX IF EXISTS idx_connection_metadata_created_at_v0_1 ON connection_metadata_v0_1;",
        "DROP INDEX IF EXISTS idx_connection_metadata_connection_id_v0_1 ON connection_metadata_v0_1;",
        "DROP INDEX IF EXISTS idx_connection_metadata_key_v0_1 ON connection_metadata_v0_1;",
        "DROP INDEX IF EXISTS idx_connection_metadata_item_name_v0_1 ON connection_metadata_v0_1;",
        "DROP INDEX IF EXISTS idx_connection_metadata_item_id_v0_1 ON connection_metadata_v0_1;",
        "DROP TABLE IF EXISTS connection_metadata_v0_1;",
    ],
}
...
# json: {"transaction_their_job": "TRANSACTION_ENDORSER", "transaction_my_job": "TRANSACTION_AUTHOR"}
