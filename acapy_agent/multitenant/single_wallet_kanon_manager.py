"""Manager for kanon profile multitenancy mode."""

from typing import Iterable, Optional, cast

#only supports KanonAnoncred Profile
from ..kanon.profile_anon_kanon import KanonAnonCredsProfile, KanonAnonProfileManager
...
class SingleWalletKanonMultitenantManager(BaseMultitenantManager):
    """Class for handling askar profile multitenancy."""

    DEFAULT_MULTITENANT_WALLET_NAME = "multitenant_sub_wallet"

    def __init__(
        self, profile: Profile, multitenant_profile: Optional[KanonAnonCredsProfile] = None
    ):
        """Initialize kanon profile multitenant Manager.
    ...
    async def get_wallet_profile(
        ...
        *,
        ...
        """Get Kanon profile for a wallet record.

        An object of type KanonProfile is returned but this should not be
        confused with the underlying profile mechanism provided by Kanon that
        ...
        if not self._multitenant_profile:
            ...
            self._multitenant_profile = cast(KanonAnonCredsProfile, profile)
