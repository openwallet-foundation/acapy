...
#         "context": MagicMock(profile=MagicMock())
#     }[key]
...
#         self.main_dir = "path/to/main/dir"
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.retrieve_by_revoc_reg_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.shutil.rmtree")
#     async def test_delete_tails_by_rev_reg_id(self, mock_rmtree, mock_retrieve):
#         mock_retrieve.return_value = MagicMock(tails_local_path=self.tails_path)
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.query_by_cred_def_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.os.path.exists", return_value=True)
#     @patch("acapy_agent.revocation.routes.os.listdir")
#     @patch("acapy_agent.revocation.routes.shutil.rmtree")
#     async def test_delete_tails_by_cred_def_id_success(
#         self, mock_rmtree, mock_listdir, mock_path_exists, mock_query
#     ):
#         mock_record = MagicMock()
#         mock_record.tails_local_path = os.path.join(self.cred_dir, "tails")
#         mock_query.return_value = [mock_record]

#         mock_listdir.return_value = [f"{self.cred_def_id}_something"]
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.query_by_cred_def_id", new_callable=AsyncMock)
#     async def test_delete_tails_by_cred_def_id_no_records_found(self, mock_query):
#         mock_query.return_value = []
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.retrieve_by_revoc_reg_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.shutil.rmtree", side_effect=FileNotFoundError)
#     async def test_delete_tails_by_rev_reg_id_file_not_found(self, mock_rmtree, mock_retrieve):
#         mock_retrieve.return_value = MagicMock(tails_local_path=self.tails_path)
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.retrieve_by_revoc_reg_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.shutil.rmtree", side_effect=Exception("generic error"))
#     async def test_delete_tails_by_rev_reg_id_exception(self, mock_rmtree, mock_retrieve):
#         mock_retrieve.return_value = MagicMock(tails_local_path=self.tails_path)
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.query_by_cred_def_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.os.listdir")
#     async def test_delete_tails_by_cred_def_id_no_matching_files(self, mock_listdir, mock_query):
#         mock_record = MagicMock()
#         mock_record.tails_local_path = os.path.join(self.cred_dir, "tails")
#         mock_query.return_value = [mock_record]

#         mock_listdir.return_value = ["unrelated_file"]
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.query_by_cred_def_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.os.listdir", side_effect=FileNotFoundError)
#     async def test_delete_tails_by_cred_def_id_file_not_found(self, mock_listdir, mock_query):
#         mock_record = MagicMock()
#         mock_record.tails_local_path = os.path.join(self.cred_dir, "tails")
#         mock_query.return_value = [mock_record]
...
#     @patch("acapy_agent.revocation.models.issuer_rev_reg_record.IssuerRevRegRecord.query_by_cred_def_id", new_callable=AsyncMock)
#     @patch("acapy_agent.revocation.routes.os.listdir", side_effect=Exception("generic error"))
#     async def test_delete_tails_by_cred_def_id_exception(self, mock_listdir, mock_query):
#         mock_record = MagicMock()
#         mock_record.tails_local_path = os.path.join(self.cred_dir, "tails")
#         mock_query.return_value = [mock_record]
...
#     @patch("acapy_agent.revocation.routes.is_anoncreds_profile_raise_web_exception")
#     async def test_delete_tails_no_query_param(self, mock_check):
...
class TestDeleteTails:
    ...
    @mock.patch("acapy_agent.revocation.routes.os.listdir")
    @mock.patch("acapy_agent.revocation.routes.shutil.rmtree")
    async def test_delete_tails_by_cred_def_id_success(self, mock_rmtree, mock_listdir, mock_path_exists, mock_query):
        mock_record = MagicMock()
        mock_record.tails_local_path = os.path.join(self.cred_dir, "tails")
        mock_query.return_value = [mock_record]
