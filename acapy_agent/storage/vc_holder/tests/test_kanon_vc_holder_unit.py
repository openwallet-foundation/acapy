...
async def test_store_retrieve_delete_and_search(patched_vc):
    ...
    rec = VCRecord(contexts={"c"}, expanded_types={"t"}, schema_ids={"s"}, issuer_id="iss", subject_ids={"sub"}, proof_types={"pt"}, cred_value={"x": 1}, given_id="gid", cred_tags={"k": "v"}, record_id="rid1")
    ...
    srch = holder.search_credentials(types=["t"], schema_ids=["s"], issuer_id="iss", given_id="gid", tag_query={"z": 1}, pd_uri_list=["u"])
