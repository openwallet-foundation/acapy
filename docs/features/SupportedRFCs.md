...
| [Indy SDK](https://github.com/hyperledger/indy-sdk/tree/master/docs/design/003-wallet-storage) | :x: | **Removed in the 1.0.0rc4 release of ACA-Py** |

> Existing deployments using the [Indy SDK] **MUST** transition to [Aries Askar] and related components to use Release 1.0.0rc4.
