...
from aries_cloudagent.protocols.present_proof.v3_0.messages.pres_format import (
    V30PresFormat,
    V30PresFormatSchema,
)
...
class AttachDecoratorData1JWSSchema(BaseModelSchema):
    ...
    signature = fields.Str(description="signature", required=False, **BASE64URL_NO_PAD)
...
class AttachDecoratorSchema(BaseModelSchema):
    ...
    format = fields.Pluck(V30PresFormatSchema, "format_")
