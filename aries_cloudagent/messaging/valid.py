...
ANY_DID_VALIDATE = AnyDID()
ANY_DID_EXAMPLE = AnyDID.EXAMPLE

ANY_DID_OR_UNQUALIFIED_VALIDATE = DIDOrUnqualified()
ANY_DID_OR_UNQUALIFIED_EXAMPLE = DIDOrUnqualified.EXAMPLE
