...
class TestAskarStorage(test_in_memory_storage.TestInMemoryStorage):
    ...
    async def test_record(self):
        with async_mock.patch.object(
            ...
            with async_mock.patch.object(
                test_module.non_secrets, "get_wallet_record", async_mock.AsyncMock()
            ) as mock_get_record:
    ...
    async def test_storage_search_x(self):
        with async_mock.patch.object(
            ...
            with async_mock.patch.object(
                indy.non_secrets, "open_wallet_search", async_mock.AsyncMock()
            ) as mock_indy_open_search, async_mock.patch.object(
                indy.non_secrets, "close_wallet_search", async_mock.AsyncMock()
