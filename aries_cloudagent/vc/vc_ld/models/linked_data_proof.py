...
from ....messaging.valid import IndyISO8601DateTime, UUIDFour, Uri
...
class LinkedDataProofSchema(BaseModelSchema):
    ...
    jws = fields.Str(
        ...
        metadata={
            ...
            "example": (
                "eyJhbGciOiAiRWREUc2UsICJjcml0IjogWyJiNjQiXX0..lKJU0Df_keb"
                "lRKhZAS9Qq6zybm-HqUXNVZ8vgEPNTAjQ1Ch6YBKY7UBAjg6iBX5qBQ"
            ),
        },
    )
    ...
    proof_value = fields.Str(
        ...
        metadata={
            ...
            "example": (
                "sy1AahqbzJQ63n9RtekmwzqZeVj494VppdAVJBnMYrTwft6cLJJGeTSSxCCJ6HKnRtwE7jj"
                "Dh6sB2z2AAiZY9BBnCD8wUVgwqH3qchGRCuC2RugA4eQ9fUrR4Yuycac3caiaaay"
            ),
        },
    )
