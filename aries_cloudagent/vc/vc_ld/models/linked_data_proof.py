...
class LinkedDataProofSchema(BaseModelSchema):
    ...
    domain = fields.Str(required=False, validate=Uri(), metadata={'description':
    ...
    jws = fields.Str(required=False, metadata={'description':
        'Associates a Detached Json Web Signature with a proof', 'example':
        'eyJhbGciOiAiRWREUc2UsICJjcml0IjogWyJiNjQiXX0..lKJU0Df_keblRKhZAS9Qq6zybm-HqUXNVZ8vgEPNTAjQ1Ch6YBKY7UBAjg6iBX5qBQ'
        })

    proof_value = fields.Str(required=False, data_key='proofValue', metadata={
        'description': 'The proof value of a proof', 'example':
    ...
    nonce = fields.Str(required=False, metadata={'description': 'The nonce',
        'example':
