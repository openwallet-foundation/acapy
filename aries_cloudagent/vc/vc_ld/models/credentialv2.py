...
class VerifiableCredentialV2(BaseModel):
    ...
    class Meta:
        """VerifiableCredentialV2 metadata."""

        schema_class = "CredentialV2Schema"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the VerifiableCredentialV2 instance."""
    ...
    def type(self, type: List[str]):
        ...
        First item must be VerifiableCredentialV2
        """
...
class CredentialV2Schema(BaseModelSchema):
    ...
    context = fields.List(
        ...
        metadata={
            ...
            "example": CREDENTIAL_V2_CONTEXT_EXAMPLE,
        },
    )
...
class VerifiableCredentialV2Schema(CredentialV2Schema):
