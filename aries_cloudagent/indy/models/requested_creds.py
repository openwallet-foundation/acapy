...
class IndyRequestedCredsRequestedAttrSchema(OpenAPISchema):
    ...
    cred_id = fields.Str(required=True, metadata={'example':
        '3fa85f64-5717-4562-b3fc-2c963f66afa6', 'description':
        'Wallet credential identifier (typically but not necessarily a UUID)'})
    revealed = fields.Bool(dump_default=True, metadata={'description':
...
class IndyRequestedCredsRequestedPredSchema(OpenAPISchema):
    ...
    cred_id = fields.Str(required=True, metadata={'description':
        'Wallet credential identifier (typically but not necessarily a UUID)',
        'example': '3fa85f64-5717-4562-b3fc-2c963f66afa6'})
    timestamp = fields.Int(required=False, validate=INT_EPOCH_VALIDATE,
        metadata={'description':
        'Epoch timestamp of interest for non-revocation proof', 'strict': True,
