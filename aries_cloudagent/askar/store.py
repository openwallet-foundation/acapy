...
class AskarStoreConfig:
    ...
    def __init__(self, config: dict = None):
        ...
        if self.key_derivation_method.lower() == self.KEY_DERIVATION_RAW.lower() and self.key == "":
            raise ProfileError(f"With key derivation method '{self.KEY_DERIVATION_RAW}', key should also be provided")
