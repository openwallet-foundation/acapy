...
class V30CredExRecordIndy(BaseRecord):
    """Credential exchange indy detail record."""

    class Meta:
        """V30CredExRecordIndy metadata."""

        schema_class = "V30CredExRecordIndySchema"

    RECORD_ID_NAME = "cred_ex_indy_id"
    RECORD_TYPE = "indy_cred_ex_V30"
