...
class V30CredExRecordLDProof(BaseRecord):
    """Credential exchange linked data proof detail record."""

    class Meta:
        """V30CredExRecordLDProof metadata."""

        schema_class = "V30CredExRecordLDProofSchema"

    RECORD_ID_NAME = "cred_ex_ld_proof_id"
    RECORD_TYPE = "ld_proof_cred_ex_V30"
    ...
    async def query_by_cred_ex_id(
        ...
        cred_ex_id: str,
    ) -> Sequence["V30CredExRecordLDProof"]:
...
class V30CredExRecordLDProofSchema(BaseRecordSchema):
    ...
    class Meta:
        ...
        model_class = V30CredExRecordLDProof
        unknown = EXCLUDE
