...
class V30CredProblemReport(ProblemReport):
    ...
    class Meta:
        ...
        schema_class = "V30CredProblemReportSchema"
        message_type = CRED_30_PROBLEM_REPORT
...
class V30CredProblemReportSchema(ProblemReportSchema):
    """Problem report schema."""

    class Meta:
        """Schema metadata."""

        model_class = V30CredProblemReport
        unknown = EXCLUDE
