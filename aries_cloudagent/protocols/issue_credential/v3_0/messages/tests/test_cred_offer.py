...
class TestV30CredOffer(AsyncTestCase):
    ...
    async def test_serde(self):
        ...
        obj = TestV30CredOffer.CRED_OFFER.serialize()

        cred_offer = V30CredOffer.deserialize(obj)
        assert type(cred_offer) == V30CredOffer
...
class TestV30CredOfferSchema(AsyncTestCase):
    ...
    async def test_make_model(self):
        ...
        model_instance = V30CredOffer.deserialize(data)
        assert isinstance(model_instance, V30CredOffer)
