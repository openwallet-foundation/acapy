...
from aries_cloudagent.protocols.issue_credential.v3_0.messages.inner.cred_preview import (
    V30CredAttrSpec,
    V30CredPreview,
    V30CredPreviewBody,
)
...
class TestV30FormatFormat(TestCase):
    ...
    def test_init_type(self):
        ...
        my_test_body = V30CredBody(
            comment="My Comment", replacement_id="x", credential_preview=TEST_PREVIEW
        )
        ...
        assert (
            my_test_body.credential_preview._body.attributes
            == TEST_PREVIEW._body.attributes
        )
