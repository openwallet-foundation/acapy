...
class LDProofCredFormatHandler(V30CredFormatHandler):
    ...
    format = V30CredFormat.Format.LD_PROOF
    ...
    def validate_fields(cls, message_type: str, attachment_data: Mapping) -> None:
        ...
        """
        mapping = {
            CRED_30_PROPOSAL: LDProofVCDetailSchema,
            CRED_30_OFFER: LDProofVCDetailSchema,
            CRED_30_REQUEST: LDProofVCDetailSchema,
            CRED_30_ISSUE: VerifiableCredentialSchema,
        }
    ...
    async def get_detail_record(self, cred_ex_id: str) -> V30CredExRecordLDProof:
    ...
    async def create_proposal(
        ...
        return self.get_format_data(CRED_30_PROPOSAL, detail.serialize())
    ...
    async def create_offer(
        ...
        return self.get_format_data(CRED_30_OFFER, detail.serialize())
    ...
    async def create_request(
        ...
        return self.get_format_data(CRED_30_REQUEST, detail.serialize())
    ...
    async def issue_credential(
        ...
        return self.get_format_data(CRED_30_ISSUE, vc)
    ...
    async def store_credential(
        ...
        if not result.verified:
            raise V30CredFormatError(f"Received invalid credential: {result}")
        ...
        detail_record = V30CredExRecordLDProof(
