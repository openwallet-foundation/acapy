...
class TestV30CredRequestHandler(AsyncTestCase):
    async def test_called(self):
        ...
        with async_mock.patch.object(
            ...
            request_context.message = V30CredRequest()
            request_context.connection_ready = True
            handler = test_module.V30CredRequestHandler()
