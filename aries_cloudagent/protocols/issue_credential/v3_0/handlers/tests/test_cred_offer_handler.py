...
class TestV30CredOfferHandler(AsyncTestCase):
    async def test_called(self):
        ...
        with async_mock.patch.object(
            ...
            request_context.message = V30CredOffer()
            request_context.connection_ready = True
            handler_inst = test_module.V30CredOfferHandler()
    ...
    async def test_called_auto_request_x(self):
        ...
        with async_mock.patch.object(
            ...
            request_context.message = V30CredOffer()
            request_context.connection_ready = True
            handler = test_module.V30CredOfferHandler()
            responder = MockResponder()
