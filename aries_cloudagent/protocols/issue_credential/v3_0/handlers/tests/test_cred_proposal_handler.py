...
class TestV30CredProposalHandler(AsyncTestCase):
    async def test_called(self):
        ...
        with async_mock.patch.object(
            ...
            request_context.message = V30CredProposal()
            request_context.connection_ready = True
            handler_inst = test_module.V30CredProposalHandler()
    ...
    async def test_called_auto_offer_x(self):
        ...
        with async_mock.patch.object(
            ...
            request_context.message = V30CredProposal()
            request_context.connection_ready = True
            handler = test_module.V30CredProposalHandler()
            responder = MockResponder()
