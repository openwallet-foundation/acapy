...
class TestV20CredRoutes(AsyncTestCase):
    ...
    async def test_credential_exchange_list(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cx_rec.query.return_value = [mock_cx_rec]
            ...
            with async_mock.patch.object(
                ...
                mock_response.assert_called_once_with(
                    {"results": [mock_cx_rec.serialize.return_value]}
                )
    ...
    async def test_credential_exchange_retrieve(self):
        ...
        with async_mock.patch.object(
            ...
            with async_mock.patch.object(
                ...
                mock_response.assert_called_once_with(
                    mock_cx_rec.serialize.return_value
                )
    ...
    async def test_credential_exchange_issue_deser_x(self):
        ...
        with async_mock.patch.object(
            ...
            mock_v20_cx_rec.retrieve_by_id = async_mock.CoroutineMock(
    ...
    async def test_credential_exchange_remove(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cx_rec.delete_record = async_mock.CoroutineMock()
    ...
    async def test_credential_exchange_remove_x(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cx_rec.retrieve_by_id = async_mock.CoroutineMock(return_value=mock_rec)
