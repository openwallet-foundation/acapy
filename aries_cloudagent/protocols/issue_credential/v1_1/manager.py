...
from .messages.inner.credential_preview import V11CredentialPreview
from .models.credential_exchange import V11CredentialExchange
...
class CredentialManager:
    ...
    async def prepare_send(
    ...
    ) -> Tuple[V11CredentialExchange, CredentialOffer]:
        """
        ...
        """
        credential_exchange = V11CredentialExchange(
            auto_issue=True,
            connection_id=connection_id,
            initiator=V11CredentialExchange.INITIATOR_SELF,
            role=V11CredentialExchange.ROLE_ISSUER,
    ...
    async def create_proposal(
        ...
        *,
        ...
        comment: str = None,
        credential_preview: V11CredentialPreview = None,
        schema_id: str = None,
        ...
        credential_exchange_record = V11CredentialExchange(
            ...
            initiator=V11CredentialExchange.INITIATOR_SELF,
            role=V11CredentialExchange.ROLE_HOLDER,
            state=V11CredentialExchange.STATE_PROPOSAL_SENT,
    ...
    async def receive_proposal(self) -> V11CredentialExchange:
        """
        ...
        credential_exchange_record = V11CredentialExchange(
            connection_id=connection_id,
            thread_id=credential_proposal_message._thread_id,
            initiator=V11CredentialExchange.INITIATOR_EXTERNAL,
            role=V11CredentialExchange.ROLE_ISSUER,
            state=V11CredentialExchange.STATE_PROPOSAL_RECEIVED,
            credential_proposal_dict=credential_proposal_message.serialize(),
    ...
    async def create_offer(
        self, credential_exchange_record: V11CredentialExchange, comment: str = None
    ) -> Tuple[V11CredentialExchange, CredentialOffer]:
        """
        ...
        credential_exchange_record.state = V11CredentialExchange.STATE_OFFER_SENT
    ...
    async def receive_offer(self) -> V11CredentialExchange:
        """
        ...
        try:
            ...
            ) = await V11CredentialExchange.retrieve_by_connection_and_thread(
        ...
        credential_exchange_record.state = V11CredentialExchange.STATE_OFFER_RECEIVED
    ...
    async def create_request(
        self, credential_exchange_record: V11CredentialExchange, holder_did: str
    ) -> Tuple[V11CredentialExchange, CredentialRequest]:
        """
        ...
        if credential_exchange_record.credential_request:
            self._logger.warning(
                "create_request called multiple times for v1.1 credential exchange: %s",
        ...
        credential_exchange_record.state = V11CredentialExchange.STATE_REQUEST_SENT
        await credential_exchange_record.save(
    ...
    async def receive_request(self):
        ...
        credential_exchange_record.state = V11CredentialExchange.STATE_REQUEST_RECEIVED
        await credential_exchange_record.save(
    ...
    async def issue_credential(
        ...
        *,
    ...
    ) -> Tuple[V11CredentialExchange, CredentialIssue]:
        """
        Issue a credential.
        ...
        credential_exchange_record.state = V11CredentialExchange.STATE_ISSUED
    ...
    async def receive_credential(self) -> V11CredentialExchange:
        """
    ...
    async def store_credential(
        self, credential_exchange_record: V11CredentialExchange
    ) -> Tuple[V11CredentialExchange, CredentialAck]:
        """
        ...
        if (
            ...
            mime_types = V11CredentialPreview.deserialize(
                credential_exchange_record.credential_proposal_dict[
                    "credential_proposal"
                ]
            ).mime_types()
        ...
        credential_exchange_record.state = V11CredentialExchange.STATE_ACKED
    ...
    async def receive_credential_ack(self) -> V11CredentialExchange:
        """
