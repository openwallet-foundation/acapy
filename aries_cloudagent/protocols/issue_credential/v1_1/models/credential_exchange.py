...
class V11CredentialExchange(BaseRecord):
    """Represents an Aries#0036 credential exchange."""

    class Meta:
        """CredentialExchange metadata."""

        schema_class = "V11CredentialExchangeSchema"

    RECORD_TYPE = "credential_exchange_v11"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize a new V11CredentialExchange."""
...
class V11CredentialExchangeSchema(BaseRecordSchema):
    ...
    class Meta:
        """V11CredentialExchangeSchema metadata."""

        model_class = V11CredentialExchange
