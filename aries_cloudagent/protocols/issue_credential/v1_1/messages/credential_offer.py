...
from .inner.credential_preview import V11CredentialPreview, V11CredentialPreviewSchema
...
class CredentialOfferSchema(AgentMessageSchema):
    ...
    credential_preview = fields.Nested(V11CredentialPreviewSchema, required=False)
