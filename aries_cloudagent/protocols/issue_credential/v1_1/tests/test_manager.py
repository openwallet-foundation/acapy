...
from ..messages.inner.credential_preview import V11CredentialPreview, V11CredAttrSpec
...
class TestCredentialManager(AsyncTestCase):
    ...
    async def test_prepare_send(self):
        ...
        preview = V11CredentialPreview(
            attributes=(V11CredAttrSpec(name="attr", value="value"),)
        )
        ...
        with async_mock.patch.object(
            ...
            assert arg_exchange.role == V11CredentialExchange.ROLE_ISSUER
    ...
    async def test_create_proposal(self):
        ...
        with async_mock.patch.object(
            V11CredentialExchange, "save", autospec=True
        ) as save_ex:
            exchange: V11CredentialExchange = await self.manager.create_proposal(
                connection_id,
                auto_offer=True,
                comment=comment,
        ...
        assert exchange.state == V11CredentialExchange.STATE_PROPOSAL_SENT
    ...
    async def test_receive_proposal(self):
        ...
        with async_mock.patch.object(
            ...
            assert exchange.role == V11CredentialExchange.ROLE_ISSUER
            assert exchange.state == V11CredentialExchange.STATE_PROPOSAL_RECEIVED
    ...
    async def test_create_free_offer(self):
        ...
        exchange = V11CredentialExchange(
            credential_definition_id=cred_def_id, role=V11CredentialExchange.ROLE_ISSUER
        )
        ...
        with async_mock.patch.object(
            ...
            assert exchange.state == V11CredentialExchange.STATE_OFFER_SENT
    ...
    async def test_create_bound_offer(self):
        ...
        with async_mock.patch.object(
            ...
            V11CredentialExchange, "get_cached_key", autospec=True
        ) as get_cached_key, async_mock.patch.object(
            V11CredentialExchange, "set_cached_key", autospec=True
        ) as set_cached_key:
    ...
    async def test_receive_offer_proposed(self):
        ...
        stored_exchange = V11CredentialExchange(
        ...
        with async_mock.patch.object(
            ...
            assert exchange.role == V11CredentialExchange.ROLE_HOLDER
            assert exchange.state == V11CredentialExchange.STATE_OFFER_RECEIVED
    ...
    async def test_create_request(self):
        ...
        with async_mock.patch.object(
            ...
            assert ret_exchange.state == V11CredentialExchange.STATE_REQUEST_SENT
    ...
    async def test_receive_request(self):
        ...
        with async_mock.patch.object(
            ...
            assert exchange.state == V11CredentialExchange.STATE_REQUEST_RECEIVED
    ...
    async def test_issue_credential(self):
        ...
        with async_mock.patch.object(
            ...
            assert ret_exchange.state == V11CredentialExchange.STATE_ISSUED
    ...
    async def test_receive_credential(self):
        ...
        with async_mock.patch.object(
            ...
            assert exchange.state == V11CredentialExchange.STATE_CREDENTIAL_RECEIVED
    ...
    async def test_store_credential(self):
        ...
        with async_mock.patch.object(
            ...
            V11CredentialPreview, "deserialize", autospec=True
            ...
            assert ret_exchange.state == V11CredentialExchange.STATE_ACKED
    ...
    async def test_credential_ack(self):
        ...
        with async_mock.patch.object(
            ...
            V11CredentialExchange, "delete_record", autospec=True
    ...
    async def test_retrieve_records(self):
        ...
        for index in range(2):
            exchange_record = V11CredentialExchange(
        ...
        for i in range(2):  # second pass gets from cache
            for index in range(2): 
                ret_ex = await V11CredentialExchange.retrieve_by_connection_and_thread(
