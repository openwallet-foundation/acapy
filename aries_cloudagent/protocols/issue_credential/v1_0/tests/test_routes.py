...
class TestCredentialRoutes(AsyncTestCase):
    ...
    async def test_credential_exchange_list(self):
        ...
        with async_mock.patch.object(
            ...
            with async_mock.patch.object(
                ...
                await test_module.credential_exchange_list(self.mock_request)
    ...
    async def test_credential_exchange_retrieve(self):
        self.mock_request.match_info = {"cred_ex_id": "dummy"}
        self.mock_request["context"].settings = {}
        ...
        with async_mock.patch.object(
            ...
            with async_mock.patch.object(
                ...
                await test_module.credential_exchange_retrieve(self.mock_request)
                mock_response.assert_called_once_with(
    ...
    async def test_credential_exchange_create(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_create(self.mock_request)
    ...
    async def test_credential_exchange_send(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_send(self.mock_request)
    ...
    async def test_credential_exchange_send_proposal(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_send_proposal(self.mock_request)

            mock_response.assert_called_once_with(
                mock_cred_ex_record.serialize.return_value
            )

            self.mock_request["outbound_message_router"].assert_called_once_with(
    ...
    async def test_credential_exchange_create_free_offer(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_create_free_offer(self.mock_request)
    ...
    async def test_credential_exchange_create_free_offer_retrieve_conn_rec_x(self):
        ...
        with async_mock.patch.object(
            ...
            with self.assertRaises(test_module.web.HTTPBadRequest):
                await test_module.credential_exchange_create_free_offer(
                    self.mock_request
                )
    ...
    async def test_credential_exchange_send_free_offer(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_send_free_offer(self.mock_request)
    ...
    async def test_credential_exchange_send_free_offer_not_ready(self):
        self.mock_request.json = async_mock.CoroutineMock()
        self.mock_request.json.return_value["auto_issue"] = True
    ...
    async def test_credential_exchange_send_bound_offer(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_send_bound_offer(self.mock_request)
    ...
    async def test_credential_exchange_send_bound_offer_bad_cred_ex_id(self):
        ...
        with async_mock.patch.object(
            ...
            with self.assertRaises(test_module.web.HTTPNotFound):
                await test_module.credential_exchange_send_bound_offer(
                    self.mock_request
                )
    ...
    async def test_credential_exchange_send_request(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_send_request(self.mock_request)
    ...
    async def test_credential_exchange_issue(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_issue(self.mock_request)
    ...
    async def test_credential_exchange_store(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_store(self.mock_request)
    ...
    async def test_credential_exchange_remove(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_remove(self.mock_request)
    ...
    async def test_credential_exchange_problem_report(self):
        ...
        with async_mock.patch.object(
            ...
            await test_module.credential_exchange_problem_report(self.mock_request)

            mock_response.assert_called_once_with({})
            self.request_dict["outbound_message_router"].assert_called_once_with(
