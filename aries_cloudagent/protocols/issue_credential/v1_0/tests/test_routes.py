...
class TestCredentialRoutes(IsolatedAsyncioTestCase):
    ...
    async def test_credential_exchange_list(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cred_ex.query = async_mock.AsyncMock()
    ...
    async def test_credential_exchange_create(self):
        ...
        with async_mock.patch.object(
            ...
            mock_credential_manager.return_value.create_offer = async_mock.AsyncMock()
    ...
    async def test_credential_exchange_issue_no_conn_record(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cred_ex_cls.retrieve_by_id = async_mock.AsyncMock(
    ...
    async def test_credential_exchange_store_x(self):
        ...
        with async_mock.patch.object(
            ...
            mock_credential_manager.return_value = async_mock.MagicMock(
                store_credential=async_mock.AsyncMock(return_value=mock_cred_ex_record),
                send_credential_ack=async_mock.AsyncMock(
    ...
    async def test_credential_exchange_remove(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cred_ex.delete_record = async_mock.AsyncMock()
    ...
    async def test_credential_exchange_remove_x(self):
        ...
        with async_mock.patch.object(
            ...
            mock_cred_ex.retrieve_by_id = async_mock.AsyncMock(return_value=mock_rec)
