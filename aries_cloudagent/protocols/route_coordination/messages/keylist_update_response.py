...
from .inner.keylist_update_result import KeylistUpdateResult, KeylistUpdateResultSchema
...
class KeylistUpdateResponse(AgentMessage):
    ...
    def __init__(
        self,
        *,
        updated: Sequence[KeylistUpdateResult] = None,
        **kwargs,
    ):
        """
...
class KeylistUpdateResponseSchema(AgentMessageSchema):
    ...
    updated = fields.List(
        fields.Nested(KeylistUpdateResultSchema()),
