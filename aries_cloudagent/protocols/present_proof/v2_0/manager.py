...
class V20PresManager:
    ...
    async def create_exchange_for_proposal(
        ...
        Args:
            ...
            auto_remove: whether to remove the presentation exchange on completion
        Returns:
    ...
    async def create_exchange_for_request(
        ...
        Args:
            ...
            auto_remove: whether to remove this presentation exchange on completion
        Returns:
    ...
    async def send_pres_ack(
        ...
        if responder:
            ...
            if pres_ex_record.auto_remove:
                async with self._profile.session() as session:
                    await pres_ex_record.delete_record(session)  # all done: delete
        else:
            LOGGER.warning(
