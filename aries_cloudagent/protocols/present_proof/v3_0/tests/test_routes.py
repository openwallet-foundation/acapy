...
class TestPresentProofRoutes(AsyncTestCase):
    ...
    async def test_validate(self):
        schema = test_module.V30PresProposalByFormatSchema()
        ...
        schema = test_module.V30PresRequestByFormatSchema()
    ...
    async def test_present_proof_credentials_list_dif(self):
        ...
        record = V30PresExRecord(
            ...
            pres_proposal=None,
            pres_request={
                "type": "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/3.0/request-presentation",
        ...
        self.request.json = async_mock.CoroutineMock(
            return_value={
                ...
                "presentation_proposal": {
                    V30PresFormat.Format.INDY.api: INDY_PROOF_REQ
                },
            }
        )
    ...
    async def test_present_proof_send_proposal_not_ready(self):
        ...
        with async_mock.patch.object(
            ...
            test_module, "V30PresProposal", autospec=True
        ) as mock_proposal:
    ...
    async def test_present_proof_create_request(self):
        ...
        self.request.json = async_mock.CoroutineMock(
            return_value={
                "comment": "dummy",
                "presentation_request": {V30PresFormat.Format.INDY.api: indy_proof_req},
            }
        )
        ...
        with async_mock.patch.object(
            ...
            test_module, "V30PresRequest", autospec=True
    ...
    async def test_present_proof_send_bound_request(self):
        ...
        with async_mock.patch.object(
            ...
            mock_px_rec_inst = async_mock.MagicMock(
                connection_id="dummy",
                state=test_module.V30PresExRecord.STATE_PROPOSAL_RECEIVED,
                serialize=async_mock.MagicMock(
                    return_value={"thread_id": "sample-thread-id"}
                ),
            )
    ...
    async def test_present_proof_send_bound_request_bad_state(self):
        ...
        with async_mock.patch.object(
            ...
            mock_px_rec_inst = async_mock.MagicMock(
                connection_id="dummy",
                state=test_module.V30PresExRecord.STATE_DONE,
                serialize=async_mock.MagicMock(
                    return_value={"thread_id": "sample-thread-id"}
                ),
            )
    ...
    async def test_present_proof_send_presentation(self):
        ...
        with async_mock.patch.object(
            ...
            mock_px_rec_inst = async_mock.MagicMock(
                connection_id="dummy",
                state=test_module.V30PresExRecord.STATE_REQUEST_RECEIVED,
                serialize=async_mock.MagicMock(
                    return_value={"thread_id": "sample-thread-id"}
                ),
            )
    ...
    async def test_present_proof_send_presentation_dif_error(self):
        ...
        px_rec_instance = V30PresExRecord(
            state="request-received",
            role="prover",
            pres_proposal=None,
            pres_request={
    ...
    async def test_present_proof_verify_presentation(self):
        ...
        with async_mock.patch.object(
            ...
            mock_px_rec_inst = async_mock.MagicMock(
                connection_id="dummy",
                state=test_module.V30PresExRecord.STATE_PRESENTATION_RECEIVED,
                serialize=async_mock.MagicMock(
                    return_value={"thread_id": "sample-thread-id"}
                ),
            )
    ...
    def test_format_attach_dif(self):
        ...
        pres_req_dict = test_module._formats_attach(
            by_format=req_dict,
            msg_type="present-proof/3.0/request-presentation",
            spec="request_presentations",
        )
        assert pres_req_dict[0].ident == "dif"
        # assert pres_req_dict.get("formats")[0].attach_id == "dif"
        assert pres_req_dict[0].data.json_ == DIF_PROOF_REQ
    ...
    async def test_v20presentationsendreqschema(self):
        ...
        with self.assertRaises(TypeError):
            test_module.V30PresSendRequestRequestSchema.load(test_input)
