...
from ...message_types import ATTACHMENT_FORMAT, PRES_30

from ..pres_format import V30PresFormat
from ..pres_body import V30PresBody
from ..pres import V30Pres
...
class TestV30Pres(TestCase):
    """Presentation tests."""

    def test_init_type(self):
        """Test initializer, type."""
        assert PRES.attachments[0].content == INDY_PROOF
        formats = []
        for atch in PRES.attachments:
    ...
    def test_serde(self):
        ...
        pres_dict["attachments"][0]["id"] = "xxx"
        with self.assertRaises(BaseModelError):
            V30Pres.deserialize(pres_dict)

        pres_dict["attachments"].append(
            {
                "id": "def",
