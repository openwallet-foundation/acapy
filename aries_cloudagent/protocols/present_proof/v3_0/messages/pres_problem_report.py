...
class V30PresProblemReport(ProblemReport):
    ...
    class Meta:
        ...
        schema_class = "V30PresProblemReportSchema"
        message_type = PRES_30_PROBLEM_REPORT
...
class V30PresProblemReportSchema(ProblemReportSchema):
    """Problem report schema."""

    class Meta:
        """Schema metadata."""

        model_class = V30PresProblemReport
        unknown = EXCLUDE
