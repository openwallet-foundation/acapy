"""present-proof-V3 format handler - supports DIF and INDY."""
...
PresFormatAttachment = Tuple[V30PresFormat, AttachDecorator]


class V30PresFormatHandlerError(BaseError):
    """Presentation exchange format error under present-proof protocol V3.0."""


class V30PresFormatHandler(ABC):
    """Base Presentation Exchange Handler."""

    format: V30PresFormat.Format = None
