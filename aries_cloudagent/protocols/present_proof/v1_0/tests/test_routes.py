...
class TestProofRoutes(AsyncTestCase):
    def setUp(self):
        ...
        self.test_instance = test_module.PresentationManager(
            self.mock_request["context"]
        )
    ...
    async def test_presentation_exchange_list(self):
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_list(self.mock_request)
    ...
    async def test_presentation_exchange_credentials_list_not_found(self):
        self.mock_request.match_info = {"pres_ex_id": "dummy"}
        ...
        with async_mock.patch(
            ...
            with self.assertRaises(test_module.web.HTTPNotFound):
                await test_module.presentation_exchange_credentials_list(
                    self.mock_request
                )
    ...
    async def test_presentation_exchange_credentials_x(self):
        ...
        self.mock_request.query = {"extra_query": {}}
        returned_credentials = [{"name": "Credential1"}, {"name": "Credential2"}]
        self.mock_request["context"] = async_mock.MagicMock(
    ...
    async def test_presentation_exchange_retrieve(self):
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_retrieve(self.mock_request)
                mock_response.assert_called_once_with(
    ...
    async def test_presentation_exchange_send_proposal(self):
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_send_proposal(self.mock_request)
                mock_response.assert_called_once_with(
    ...
    async def test_presentation_exchange_send_free_request(self):
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_send_free_request(
                    self.mock_request
                )
                mock_response.assert_called_once_with(
                    mock_presentation_exchange.serialize.return_value
    ...
    async def test_presentation_exchange_send_bound_request(self):
        ...
        self.mock_request.match_info = {"pres_ex_id": "dummy"}
        self.mock_request["context"] = async_mock.CoroutineMock(
            inject=async_mock.CoroutineMock(
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_send_bound_request(
                    self.mock_request
                )
                mock_response.assert_called_once_with(
                    mock_presentation_exchange.serialize.return_value
    ...
    async def test_presentation_exchange_send_presentation(self):
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_send_presentation(
                    self.mock_request
                )
                mock_response.assert_called_once_with(
                    mock_presentation_exchange.serialize.return_value
    ...
    async def test_presentation_exchange_verify_presentation(self):
        self.mock_request.match_info = {"pres_ex_id": "dummy"}
        self.mock_request["context"] = async_mock.MagicMock(settings={})
    ...
    async def test_presentation_exchange_remove(self):
        ...
        with async_mock.patch(
            ...
            with async_mock.patch.object(
                ...
                await test_module.presentation_exchange_remove(self.mock_request)
                mock_response.assert_called_once_with({})
