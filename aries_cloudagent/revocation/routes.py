...
class RevRegCreateRequestSchema(OpenAPISchema):
    ...
    max_cred_num = fields.Int(
        required=False,
        validate=IndyRevRegSize(),
        metadata={
            "description": "Revocation registry size",
            "strict": True,
            "example": IndyRevRegSize.EXAMPLE,
        },
    )
...
class PublishRevocationsSchema(OpenAPISchema):
    ...
    rrid2crid = fields.Dict(
        required=False,
        keys=fields.Str(metadata={"example": IndyRevRegId.EXAMPLE}),
        values=fields.List(
            fields.Str(
                validate=IndyCredRevId(),
                metadata={
...
class RevRegUpdateTailsFileUriSchema(OpenAPISchema):
    ...
    tails_public_uri = fields.Url(
        ...
        metadata={
            ...
            "example": (
                "http://192.168.56.133:6543/revocation/"
                f"registry/{IndyRevRegId.EXAMPLE}/tails-file"
            ),
        },
    )
