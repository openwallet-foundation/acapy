...
class TestIndyVdrLedger:
    ...
    async def test_submit_signed(
        ...
        test_did = await wallet.create_public_did(DIDMethod.SOV, ED25519)
    ...
    async def test_register_nym_local(
        ...
        public_did = await wallet.create_public_did(DIDMethod.SOV, ED25519)
        post_did = await wallet.create_local_did(DIDMethod.SOV, ED25519)
        async with ledger:
