...
class IndyHolder(BaseHolder):
    ...
    async def store_credential(
        ...
        Args:
            ...
            credential_request_metadata: credential request metadata generated by
                the issuer
            credential_attr_metadata: dict mapping attribute name to encoding and
                MIME type (default 'text/plain') to store as non-secret, if specified
                    ...
                    attr: json.dumps(
                        {
                            ...
                            **(credential_attr_metadata.get(attr))
                        }
                    )
    ...
    async def get_metadata(self, credential_id: str, attr: str = None) -> dict:
        ...
        if attr:
            ...
            raise StorageError(
                f"Attribute {attr} has no tag in metadata record for {credential_id}"
            )
