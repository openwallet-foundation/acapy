...
class FieldSignatureException(Exception):
    pass
...
class FieldSignature:
    ...
    async def decode(self, wallet: BaseWallet) -> (object, int):
        """
        ...
        if not await wallet.verify_message(msg_bin, sig_bin, self.signer):
            raise FieldSignatureException("Signature verification failed")
...
class FieldSignatureSchema(Schema):
