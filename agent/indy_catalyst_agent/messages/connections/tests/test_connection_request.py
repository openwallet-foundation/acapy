...
class TestConnectionRequest(TestCase):
    ...
    @mock.patch(
        "indy_catalyst_agent.messages.connections.connection_request.ConnectionRequestSchema.load"
    )
    ...
    @mock.patch(
        "indy_catalyst_agent.messages.connections.connection_request.ConnectionRequestSchema.dump"
    )
